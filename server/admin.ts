...
import { ListObjectsCommand, ListObjectsCommandOutput, GetObjectCommand, GetObjectCommandOutput } from '@aws-sdk/client-s3';
...
const admin: FastifyPluginAsync = async (server: FastifyInstance): Promise<void> => {
